                ...
                <div className="div3">
                    <div className="about-container">
                        <div className="about-description">
                            ...
                            <p>Preocupada por la falta de alternativas eco-friendly, Marina se propuso fundar una agencia de experiencias turísticas donde el respeto por la naturaleza fuera la principal prioridad. Así nació Econotravel Barcelona.
                            </p>
                        </div>
                    </div>
                </div>
